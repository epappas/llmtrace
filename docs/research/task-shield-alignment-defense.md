...
### Implement Task-Alignment Scoring as an Orthogonal Defense Layer (P1 -- High Priority)
...
### Test Adaptive Attacks Against Alignment-Based Defense (P2 -- Medium Priority)
